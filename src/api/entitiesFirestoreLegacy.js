// Adaptador Firestore original — SUBSTITUÍDO por src/api/entities.js (cliente
// HTTP Postgres/Neon) no cutover (item 2 do runbook,
// docs/claude/postgres-cutover-runbook.md). Mantido intocado como referência
// de rollback: redeployar um build anterior desta branch volta a apontar
// entities.js pra este arquivo, sem precisar reescrever nada. Nenhum
// consumidor real importa este arquivo mais.
import {
  collection,
  doc,
  getDoc,
