// Fase 1 (docs/known-risks.md item 56 "Fase 1") — tripwire de segurança
// (papel de Segurança do conselho): pineConfig.rf1hCondEnabled tem que
...
// diria quebraria por um motivo não relacionado a este teste.
...
// `:` depois do nome — bate com uma entrada de objeto real (`rf1hCondEnabled:
// false,`), não com a menção em prosa dentro de um comentário explicativo
// (sem `:` logo em seguida) que os 3 arquivos já têm de propósito.
const KEY_AS_OBJECT_ENTRY = /rf1hCondEnabled\s*:/;

describe('rf1hCondEnabled — tripwire de isolamento backtest-only', () => {
