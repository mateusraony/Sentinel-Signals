// docs/known-risks.md item 71 — tripwire de segurança, mesmo padrão do
// rf1hCondTripwire.test.js: pineConfig.allowedSide tem que existir SÓ em
...
// antes de virar um toggle de produção (mudança de ESTRATÉGIA, não detalhe
// de mecanismo) sem gate de revisão de código.
//
...
// (`allowedSide: null,`), não com a menção em prosa dentro de um
// comentário explicativo (sem `:` logo em seguida) que os 3 arquivos já
// têm de propósito.
const KEY_AS_OBJECT_ENTRY = /allowedSide\s*:/;

describe('allowedSide — tripwire de isolamento backtest-only', () => {
  ...
  // DEFAULTS. Bastaria adicionar 'allowedSide' ao array (sem tocar DEFAULTS
