// docs/known-risks.md item 68 — tripwire de segurança, mesmo padrão do
// rf1hCondTripwire.test.js: pineConfig.rf1hUncondEnabled tem que existir SÓ
// em scripts/backtestPineConfig.js. Se essa chave algum dia aparecer como
...
// (`rf1hUncondEnabled: false,`), não com a menção em prosa dentro de um
// comentário explicativo (sem `:` logo em seguida) que os 3 arquivos já
// têm de propósito.
const KEY_AS_OBJECT_ENTRY = /rf1hUncondEnabled\s*:/;

describe('rf1hUncondEnabled — tripwire de isolamento backtest-only', () => {
  ...
  // DEFAULTS. Bastaria adicionar 'rf1hUncondEnabled' ao array (sem tocar DEFAULTS
