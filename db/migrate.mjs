...
// `pg_advisory_lock` é session-scoped — só serializa dentro do MESMO
// processo `node` se usado do jeito errado; aqui funciona porque cada
// arquivo de teste abre sua PRÓPRIA conexão (client novo), então o lock
// realmente serializa entre processos/threads diferentes do vitest.
